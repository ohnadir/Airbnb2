            ...
            <div>
                ...
                <div className={style.imageContainer} id='imageContainer'>
                    <div  style={{"width" :"50%", "height": "100%"}} className="">
                        {
                            product?.img ? <img style={{"height":"100%"}} src={product?.img[0]}  alt=""/> : ""
                        }
                    </div>
                    <div style={{"width" :"50%"}} className={style.image}>
                        <div>
                            {
                        ...
                        <div>
                            {
                                product?.img ? <img className="" src={product?.img[2]}  alt=""/> : ""
                            }
                        </div>
                        <div>
                            {
                        ...
                        <div>
                            {
                                product?.img ? <img className="" src={product?.img[4]}  alt=""/> : ""
                            }
                        </div>
                    </div>
                </div>
